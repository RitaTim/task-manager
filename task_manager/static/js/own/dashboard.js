$(document).ready(function() {
    ...
    var lst_tasks_dom = function(tasks){
        ...
        $.each( tasks, function( index, task ){
            lst_res += "<li class = '" + task.style + (task.main_task ? " subtask " : " ") + "board_item board_item_color' id=" + task.id + "><a><b><p class='task_title' id='" + task.id + "'>" + task.title + "</p></b></a><div class='row'><p class='col-sm-9'>" + task.text + "</p><div class='col-sm-2 assigned-ticket text-center'>" + task.assigned__username + "</div></div></li>";
        })
        return lst_res;
    };
