...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'comment_comment', (
            ...
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Forum'], blank=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['task.Task'], blank=True)),
    ...
    models = {
        ...
        u'comment.comment': {
            ...
            'forum': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['forum.Forum']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['task.Task']", 'blank': 'True'}),
